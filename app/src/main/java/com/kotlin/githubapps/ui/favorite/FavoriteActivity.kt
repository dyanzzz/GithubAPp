...
import com.kotlin.githubapps.databinding.ActivityFavoriteBinding
import com.kotlin.githubapps.ui.detail.DetailUserActivity
import com.kotlin.githubapps.ui.main.UserAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getFavoriteUser()?.observe(this, {
            if (it != null) {
                ...
                // ketika berbeda type data
                // tyope data pada Dao adalah List & pada implement viewModel adalah ArrayList
                // maka perlu proses mapping
                val list = mapList(it)
                // adapter.setList(it) // ->
